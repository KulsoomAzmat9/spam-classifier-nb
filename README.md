...
A machine learning web application that classifies emails as *Spam* or *Not Spam* using the Naive Bayes algorithm. Built with Python, Scikit-learn, and Flask.
...
- *Web Interface*: Simple Flask app to test emails in real-time
...
### *Conclusion*
Naive Bayes was chosen for the final implementation because it provides a great balance of speed, accuracy, and simplicity for spam detection. While SVM may give slightly higher accuracy, it is much slower to train. Logistic Regression is a good alternative but Naive Bayes handles word frequency better for emails.
